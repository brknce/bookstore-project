package com.example.rg.controller.handler;
...
import com.example.rg.dto.error.ErrorResponse;
...
public class RestControllerErrorHandler {
	...
	public ErrorResponse handleCustomerAlreadyExistException(ExistingCustomerException e) {
		return new ErrorResponse("Customer Rest API", e.getMessage());
	}
