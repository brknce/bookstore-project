package com.example.publisher.controller.handler;
...
import com.example.publisher.dto.error.ErrorResponse;
...
public class RestControllerErrorHandler {
	...
	public ErrorResponse handleCustomerNotFoundException(BookNotFoundException e) {
